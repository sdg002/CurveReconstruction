...
#Plot along X
#But sine and cosine expect theta in radians
#y=cos(theta)
#
#define wavelength along x (1/3 of screen width)
#define amplitude along y  (1/2 of ht)
#increment along X, theta=x/wavelength*2pie
#mpy output ny amplitude
